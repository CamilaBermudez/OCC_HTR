# OCR evaluation — vitroberta_T2_stretch_bpe_val300

Ground truth: `data/processed/annotated_samples/OCR/validation` (300 lines)

Models compared:
- `T2` from `data/processed/transcription/vitroberta_T2_stretch_bpe_val300`

| model | lines | CER | char_acc | WER | word_acc | CER_median | WER_median | missing |
|---|---|---|---|---|---|---|---|---|
| T2 | 299 | 0.0459 | 0.9541 | 0.2290 | 0.7710 | 0.0286 | 0.2000 | 0 |
