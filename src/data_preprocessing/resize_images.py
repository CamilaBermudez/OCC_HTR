...
def resize_all_images(input_dir: Union[str, Path], output_dir: Union[str, Path], 
                      target_size: int = 224, fill_color: int = 0, logs_dir: Optional[str] = None, run_name: Optional[str] = None) -> dict:
    ...
    image_files = [f for f in input_dir.rglob('*') if f.suffix.lower() in image_extensions and f.is_file()]
